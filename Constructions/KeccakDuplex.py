...
import KeccakSponge # For KeccakError. TODO better way?
import KeccakF
...
class KeccakDuplex:
  ...
  def Duplex(self, sigma, n=1024):
    """
    sigma: message pair (length in bits, string of hex characters ('9AFC...')
    ...
    # Padding
    P = self.pad10star1(sigma, self.r)
